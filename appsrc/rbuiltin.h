...
template<> struct type_name<void       > { static constexpr const char *const name = "void"  ; };
template<> struct type_name<bool       > { static constexpr const char *const name = "bool"  ; };
template<> struct type_name<uint8_t    > { static constexpr const char *const name = "byte"  ; };
template<> struct type_name<int        > { static constexpr const char *const name = "int"   ; };
template<> struct type_name<int64_t    > { static constexpr const char *const name = "int64" ; };
template<> struct type_name<float      > { static constexpr const char *const name = "float" ; };
template<> struct type_name<double     > { static constexpr const char *const name = "double"; };
template<> struct type_name<std::string> { static constexpr const char *const name = "string"; };
