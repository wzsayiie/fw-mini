...
protected:
    /*non*/ void onException(const std::string &message);
    virtual void onRegisterFunction(const std::string &name, const MBaseFunction::ptr &func);
    virtual void onEvaluate(const std::string &name, const std::string &script);
